...
{
    public partial class WorkOrder14 : Form
    {
        ...
        private void WorkOrder14_Load(object sender, EventArgs e)
        {
        ...
        private void init()
        {
            ...
            ReportParameterCollection operatorsParameter10 = new ReportParameterCollection();
            ReportParameterCollection machineParameter10 = new ReportParameterCollection();
            ReportParameterCollection companyParameter10 = new ReportParameterCollection();
            ReportParameterCollection productParameter10 = new ReportParameterCollection();
            ReportParameterCollection timeParameter10 = new ReportParameterCollection();
            ReportParameterCollection timeDueParameter10 = new ReportParameterCollection();
            ReportParameterCollection explanationParameter10 = new ReportParameterCollection();

            ReportParameterCollection operatorsParameter11 = new ReportParameterCollection();
            ReportParameterCollection machineParameter11 = new ReportParameterCollection();
            ReportParameterCollection companyParameter11 = new ReportParameterCollection();
            ReportParameterCollection productParameter11 = new ReportParameterCollection();
            ReportParameterCollection timeParameter11 = new ReportParameterCollection();
            ReportParameterCollection timeDueParameter11 = new ReportParameterCollection();
            ReportParameterCollection explanationParameter11 = new ReportParameterCollection();

            ReportParameterCollection operatorsParameter12 = new ReportParameterCollection();
            ReportParameterCollection machineParameter12 = new ReportParameterCollection();
            ReportParameterCollection companyParameter12 = new ReportParameterCollection();
            ReportParameterCollection productParameter12 = new ReportParameterCollection();
            ReportParameterCollection timeParameter12 = new ReportParameterCollection();
            ReportParameterCollection timeDueParameter12 = new ReportParameterCollection();
            ReportParameterCollection explanationParameter12 = new ReportParameterCollection();

            ReportParameterCollection operatorsParameter13 = new ReportParameterCollection();
            ReportParameterCollection machineParameter13 = new ReportParameterCollection();
            ReportParameterCollection companyParameter13 = new ReportParameterCollection();
            ReportParameterCollection productParameter13 = new ReportParameterCollection();
            ReportParameterCollection timeParameter13 = new ReportParameterCollection();
            ReportParameterCollection timeDueParameter13 = new ReportParameterCollection();
            ReportParameterCollection explanationParameter13 = new ReportParameterCollection();

            ReportParameterCollection operatorsParameter14 = new ReportParameterCollection();
            ReportParameterCollection machineParameter14 = new ReportParameterCollection();
            ReportParameterCollection companyParameter14 = new ReportParameterCollection();
            ReportParameterCollection productParameter14 = new ReportParameterCollection();
            ReportParameterCollection timeParameter14 = new ReportParameterCollection();
            ReportParameterCollection timeDueParameter14 = new ReportParameterCollection();
            ReportParameterCollection explanationParameter14 = new ReportParameterCollection();
            ...
            operatorsParameter6.Add(new ReportParameter("operator10", dT.Rows[9][1].ToString()));
            machineParameter6.Add(new ReportParameter("machine10", dT.Rows[9][2].ToString()));
            companyParameter6.Add(new ReportParameter("company10", dT.Rows[9][3].ToString()));
            productParameter6.Add(new ReportParameter("product10", dT.Rows[9][4].ToString()));
            timeParameter6.Add(new ReportParameter("time10", dT.Rows[9][5].ToString()));
            timeDueParameter6.Add(new ReportParameter("timeDue10", dT.Rows[9][6].ToString()));
            explanationParameter6.Add(new ReportParameter("explanation10", dT.Rows[9][7].ToString()));

            operatorsParameter6.Add(new ReportParameter("operator11", dT.Rows[10][1].ToString()));
            machineParameter6.Add(new ReportParameter("machine11", dT.Rows[10][2].ToString()));
            companyParameter6.Add(new ReportParameter("company11", dT.Rows[10][3].ToString()));
            productParameter6.Add(new ReportParameter("product11", dT.Rows[10][4].ToString()));
            timeParameter6.Add(new ReportParameter("time11", dT.Rows[10][5].ToString()));
            timeDueParameter6.Add(new ReportParameter("timeDue11", dT.Rows[10][6].ToString()));
            explanationParameter6.Add(new ReportParameter("explanation11", dT.Rows[10][7].ToString()));

            operatorsParameter6.Add(new ReportParameter("operator12", dT.Rows[11][1].ToString()));
            machineParameter6.Add(new ReportParameter("machine12", dT.Rows[11][2].ToString()));
            companyParameter6.Add(new ReportParameter("company12", dT.Rows[11][3].ToString()));
            productParameter6.Add(new ReportParameter("product12", dT.Rows[11][4].ToString()));
            timeParameter6.Add(new ReportParameter("time12", dT.Rows[11][5].ToString()));
            timeDueParameter6.Add(new ReportParameter("timeDue12", dT.Rows[11][6].ToString()));
            explanationParameter6.Add(new ReportParameter("explanation12", dT.Rows[11][7].ToString()));

            operatorsParameter6.Add(new ReportParameter("operator13", dT.Rows[12][1].ToString()));
            machineParameter6.Add(new ReportParameter("machine13", dT.Rows[12][2].ToString()));
            companyParameter6.Add(new ReportParameter("company13", dT.Rows[12][3].ToString()));
            productParameter6.Add(new ReportParameter("product13", dT.Rows[12][4].ToString()));
            timeParameter6.Add(new ReportParameter("time13", dT.Rows[12][5].ToString()));
            timeDueParameter6.Add(new ReportParameter("timeDue13", dT.Rows[12][6].ToString()));
            explanationParameter6.Add(new ReportParameter("explanation13", dT.Rows[12][7].ToString()));

            operatorsParameter6.Add(new ReportParameter("operator14", dT.Rows[13][1].ToString()));
            machineParameter6.Add(new ReportParameter("machine14", dT.Rows[13][2].ToString()));
            companyParameter6.Add(new ReportParameter("company14", dT.Rows[13][3].ToString()));
            productParameter6.Add(new ReportParameter("product14", dT.Rows[13][4].ToString()));
            timeParameter6.Add(new ReportParameter("time14", dT.Rows[13][5].ToString()));
            timeDueParameter6.Add(new ReportParameter("timeDue14", dT.Rows[13][6].ToString()));
            explanationParameter6.Add(new ReportParameter("explanation14", dT.Rows[13][7].ToString()));
            ...
            this.reportViewer1.LocalReport.SetParameters(operatorsParameter10);
            this.reportViewer1.LocalReport.SetParameters(machineParameter10);
            this.reportViewer1.LocalReport.SetParameters(companyParameter10);
            this.reportViewer1.LocalReport.SetParameters(productParameter10);
            this.reportViewer1.LocalReport.SetParameters(timeParameter10);
            this.reportViewer1.LocalReport.SetParameters(timeDueParameter10);
            this.reportViewer1.LocalReport.SetParameters(explanationParameter10);

            this.reportViewer1.LocalReport.SetParameters(operatorsParameter11);
            this.reportViewer1.LocalReport.SetParameters(machineParameter11);
            this.reportViewer1.LocalReport.SetParameters(companyParameter11);
            this.reportViewer1.LocalReport.SetParameters(productParameter11);
            this.reportViewer1.LocalReport.SetParameters(timeParameter11);
            this.reportViewer1.LocalReport.SetParameters(timeDueParameter11);
            this.reportViewer1.LocalReport.SetParameters(explanationParameter11);

            this.reportViewer1.LocalReport.SetParameters(operatorsParameter12);
            this.reportViewer1.LocalReport.SetParameters(machineParameter12);
            this.reportViewer1.LocalReport.SetParameters(companyParameter12);
            this.reportViewer1.LocalReport.SetParameters(productParameter12);
            this.reportViewer1.LocalReport.SetParameters(timeParameter12);
            this.reportViewer1.LocalReport.SetParameters(timeDueParameter12);
            this.reportViewer1.LocalReport.SetParameters(explanationParameter12);

            this.reportViewer1.LocalReport.SetParameters(operatorsParameter13);
            this.reportViewer1.LocalReport.SetParameters(machineParameter13);
            this.reportViewer1.LocalReport.SetParameters(companyParameter13);
            this.reportViewer1.LocalReport.SetParameters(productParameter13);
            this.reportViewer1.LocalReport.SetParameters(timeParameter13);
            this.reportViewer1.LocalReport.SetParameters(timeDueParameter13);
            this.reportViewer1.LocalReport.SetParameters(explanationParameter13);

            this.reportViewer1.LocalReport.SetParameters(operatorsParameter14);
            this.reportViewer1.LocalReport.SetParameters(machineParameter14);
            this.reportViewer1.LocalReport.SetParameters(companyParameter14);
            this.reportViewer1.LocalReport.SetParameters(productParameter14);
            this.reportViewer1.LocalReport.SetParameters(timeParameter14);
            this.reportViewer1.LocalReport.SetParameters(timeDueParameter14);
            this.reportViewer1.LocalReport.SetParameters(explanationParameter14);
